...
<body>
{{Session::pull('paypalPayKey','null')}}
<br/>
<?php
        $ppResponse = Session::pull('ppResponse','null');
        echo 'PayID=>'.$ppResponse->payKey.'<br/>';
        echo 'PaymentDate=>'.$ppResponse->responseEnvelope->timestamp;
?>
</body>
</html>