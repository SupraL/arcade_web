        ...
        <div class="tab-pane fade" id="tabus3" role="tabpanel">
            <div class="card">
                <div class="container">
                    ...
                    <hr />
						<pre style="margin-right: 30px;word-wrap: break-word;white-space: pre-wrap">
本網站的瀏覽者需要明白的是，本網站 —— Arcade Crafts 遊戲工作室（以下簡稱本工作室）屬於小本經營，並沒有大財團的支持。因此，本工作室之服務僅依其當前所呈現的狀況提供，本服務涉及到互聯網及移動通訊等服務，可能會受到各個環節不穩定因素的影響。因此服務存在因上述不可抗力、電腦病毒或黑客攻擊、系統不穩定、用戶所在位置、用戶關機、GSM網絡、互聯網絡、通信線路原因等造成的服務中斷或不能滿足用戶要求的風險。您須考慮以上風險，本工作室對服務之及時性、安全性、準確性均不作擔保，因此若出現用戶不能發送和接受閱讀消息、無法成功使用服務、或連接伺服器的情況，而導致各位玩家設定之時效、未予儲存導致遊戲資料流失或其他問題，本工作室將不承擔任何責任。
...
(3.3) 凍結玩家帳戶數小時至數天不等。此處分的凍結時間及詳細原因將會經由電子信箱通知。
(3.4) 終止玩家帳戶。此處分代表玩家將無期限停權，關於此處分的詳細原因將會經由電子信箱通知。
