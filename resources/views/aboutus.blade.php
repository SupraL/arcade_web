...
任何涉及違反行為規範或使用條款的行為將會遭受本工作室的工作人員進一步的調查。本工作室保留權力暫停、終止或刪除用戶帳號，並且無須事先通知或警告，詳情請參閱有關本工作室的<a href="aboutUs#tabus3">《服務政策》</a>。
...
(4.4.11)	其他違背相關法律之行為
對於會員的違約行為，本工作室將依《服務政策》所列方式予以處分。
...
- 銀行入數（香港）
- 支付寶（中國）
請注意，一旦完成購買，除非系統出錯，本工作室不會以任何形式進行退款。
