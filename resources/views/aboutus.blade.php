...
- 銀行入數（香港）
- 支付寶（中國）
請注意，一旦完成整個購買程序，除非系統出錯，本工作室不會以任何形式的退還。服務的品質除非遇到第一段所示之情況外，保證維持7*24的服務時間。
        ...
        <div class="tab-pane fade" id="tabus4" role="tabpanel">
            <div class="card">
                <div class="container">
                    ...
                    <hr />
						<pre style="margin-right: 30px;word-wrap: break-word;white-space: pre-wrap">
Arcade Crafts 遊戲工作室 (以下簡稱「本工作室」或「我們」) 在用戶使用本網站及其服務時，必定尊重閣下的私隱，並竭力維護閣下的個人資料得到保密。此私隱政策說明我們如何收集、使用及披露閣下的個人資料，也就是可用於識別閣下的個人身份的相關資料，例如閣下的姓名、性別、居住地區、手提電話號碼、電郵地址、出生日期和密碼。該類資料在本政策中稱為「個人資料」。我們承諾遵守香港《個人資料(私隱)條例》(第486章)之要求，而我們在遵行上述的要求時，會確保僱員遵守最嚴格的安全及保密標準。

(1) 個人資料之收集
(1.1) 當閣下使用arcadecrafts.net建立會員帳號填寫註冊表格時或登入網站使用連線遊戲、信息和虛擬社區時，我們會要求閣下提供個人資料。
(1.2) 為了向閣下提供服務及資訊，我們必須獲得閣下的個人資料，如閣下未能提供有關的個人資料，我們將無法向閣下提供任何服務及資訊。如閣下對於提供資料給我們或對資料用於私隱政策中所允許的任何方式有任何疑慮，則閣下不應使用我們的服務。
(1.3) 閣下建立會員帳號或登入使用arcadecrafts.net，即表示閣下同意接受此私隱政策，並且同意下文所載私隱政策預期對閣下的個人資料所進行的使用和披露。
(1.4) 如閣下未滿十八歲，閣下的家長 (法定代理人或監護人) 須先詳閱並同意我們的<a href="aboutUs#tabus3">《服務條款》</a>、<a href="aboutUs#tabus3">《服務政策》</a>及本私隱政策，方可向我們提供任何資料/或使用我們的服務。

(2) 收集個人資料之目的/用途
假如閣下提供任何個人資料給我們，即閣下同意我們收集、保留及使用閣下個人資料作以下目的:
(a)	確認閣下身份;
(b)	處理閣下在arcadecrafts.net所要求的產品和服務，包括連線遊戲、社群功能、通訊、下載、訂閱、推廣和比賽；
(c)	與閣下聯絡，例如在我們提供客戶支援或向閣下傳送我們的服務更新時；
(d)	管理閣下的帳號及會籍，提供客戶服務給閣下及回覆閣下的查詢、意見或要求；
(e)	提升我們的服務，例如協助我們修正錯誤或提供服務更新；進行商業調查研究和統計分析以改善我們的遊戲和服務及作市場營銷和推廣之用；
(f)	使用閣下的個人資料藉以執行使用規章、任何閣下與本工作室訂立的其他協議及任何對閣下使用arcadecrafts.net適用的其他規則或行為守則；
(g)	調查投訴，防範欺瞞、犯罪或詐騙的行為。

(3) 個人資料之披露及轉移
閣下的個人資料只供本工作室獲授權之員工/人士查閱和使用。
...
若閣下關閉會員帳號，或我們停止提供服務給閣下後, 閣下的個人資料保存的時間，一般不得超過需要使用資料作既定用途 (或有直接關係的用途) 的時間。
基於下列合理必要性，我們可能會繼續保存閣下的個人資料：遵循法律管限、符合法規要求、解決會員之間的爭議、調查投訴、防範欺瞞、犯罪或詐騙的行為，或執行本私隱政策。
...
(6) 連結
我們的網站arcadecrafts.net載有由第三方所運作的網站及網頁連結。閣下的個人資料不會因閣下進入該第三方網站及網頁而被轉移。我們沒有權控制該第三方如何收集閣下的個人資料。如閣下瀏覽第三方網站及網頁，務請先閱讀其私隱政策，以了解他們如何收集及使用閣下的個人資料。
每次閣下登入我們的網站arcadecrafts.net時，我們會自動收集以下資料，不再另行通知:
(6.1) 閣下的互聯網地址（及電腦域名）
(6.2) 裝置的型號
(6.3) 作業系統（識別閣下正在使用的網絡和裝置的獨特號碼）
(6.4) 登入的日期和時間
(6.5) 瀏覽器的類型和配置、語言設置﹑地區
(6.6) 曾瀏覽的網站及網頁包括其使用時間和長短
收集的目的是計算本網站的通訊量、各部分資料的受歡迎程度、搜集瀏覽者的一般資料、及向廣告客戶推銷網站服務。在此情況下，該等廣告客戶有可能會獲得一些撮要的通訊量數據，但這些數據並不會揭露你的個人身份。

(7) 曲奇 (cookies)
曲奇是每當使用者溜覽網頁時由電腦製造的少量數據。 曲奇可用於辨認電腦，但不用於收集個人資料。 即是，曲奇沒有識別個別網頁使用者的功能。於此網頁內，曲奇會被用於提升你溜覽網頁的質素，例如：
‧	必須使用的曲奇 (Strictly necessary cookies) - 用作確認你正使用網頁及儲存你於表格內填妥的資料或辦理付款手續時提供的詳細資料。若沒有 “必須使用的曲奇”，你所提供的資料將於你離開網頁到另外的網頁後消失。
‧	性能曲奇 (Performance cookies) - 用於收集有關訪客使用網頁時的不記名資料，而且我們會用這些集體的數據於提升我們網頁的服務質素。
‧	功能性曲奇(Functional cookies ) - 用於記錄你曾選擇的項目以及向你推薦其他與你及你的興趣有關的網頁內容。
於某些網頁內，我們已安裝了〝分享〞的按鈕或可連接其他普遍使用的社交網頁例如Facebook及Twitter的小工具。這些網頁可能有個別安裝曲奇以於你登入使用他們的服務時識別你個人身份。我們不會監控這些曲奇，因此請你向個別第三方網頁查詢該網頁如何使用你的資料及拒絕讓第三方收集你資料的方法。
若你使用或繼續使用我們的網頁，我們會假定你樂意接受我們設定曲奇。你可透過更改你的網頁溜覽器的設定隨時選擇拒絕全部或某些曲奇。請到www.allaboutcookies.org了解管理曲奇的方法。然而，請留意若你選擇刪除或限制曲奇的使用，你可能將不能使用我們的網頁的某些功能。

(8) 使用資料作直接促銷
本工作室在未獲得閣下的同意前，不會使用閣下的個人資料作直接促銷之用，亦不會向第三方披露閣下的個人資料作其直銷用途。如我們擬使用閣下的個人資料作直接促銷之用，我們將根據《個人資料(私隱)條例》之相關條款取得閣下的同意。
我們會讓閣下選擇是否接收由我們發出有關arcadecrafts.net連線遊戲、服務和優惠的市場促銷資訊。如閣下選擇接收這些市場促銷資訊，我們可能會透過閣下的電郵地址提供該等市場促銷資訊予閣下。

(9) 廣告
當閣下瀏覽網站時，本工作室和第三方廠商會以第一方 Cookies 及第三方識別碼方式不記名搜集閣下使用網站的瀏覽活動資訊。為進一步了解訪客使用體驗，本網站已安裝Google Analytics (分析) 廣告功能。若閣下希望停止使用分析廣告功能，可以到訪Google相關服務網頁查詢。

(10) 適用法律
本聲明的內容受香港特別行政區的法律管轄。就本聲明的內容引起或與其有關的爭議，閣下及本工作室同意接受香港特別行政區法院的專屬司法管轄權管轄。
查閱或更正個人資料之權利

閣下有權向本網站書面查詢本網站是否擁有閣下的個人資料，以及要求取得該等資料的副本及／或更正該等資料。閣下可向本網站資料保障主任提出上述要求，本網站在接獲此等要求後，將盡快（在不多於六十天內）處理。

我們將不時修正或更新本私隱政策聲明，所有資料將受我們最新版本之私隱政策規管, 請閣下定期瀏覽 arcadecarfts.net.
本私隱政策並不限制閣下作為資料當事人在《個人資料(私隱)條例》下享有的權利。
						</pre>
                </div>
            </div>
        </div>
